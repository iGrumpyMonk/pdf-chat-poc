...
def rewrite_question_with_context(llm: ChatOpenAI, question: str, history: list) -> str:
    return question


def route_question(llm: ChatOpenAI, question: str) -> str:
...
def handle_sql_question(llm: ChatOpenAI, question: str, history: list = None) -> dict:
    db = get_sql_database()
...
def handle_docs_question(llm: ChatOpenAI, vs, question: str) -> dict:
    try:
